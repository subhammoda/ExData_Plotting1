...
tab2$Voltage <- as.numeric(as.character(tab2$Voltage))
tab2$Global_active_power <- as.numeric(as.character(tab2$Global_active_power))
tab2$Global_reactive_power <- as.numeric(as.character(tab2$Global_reactive_power))

#plotting the requiered graph
par(mfrow = c(2,2))
plot(datetime,tab2$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")
plot(datetime,tab2$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
...
plot(datetime,tab2$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global Reactive Power ")
